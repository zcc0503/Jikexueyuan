...
CREATE TABLE IF NOT EXISTS `news_baijia` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8 COMMENT='百家新闻列表';

-- 正在导出表  baidunews.news_baijia 的数据：~11 rows (大约)
DELETE FROM `news_baijia`;
/*!40000 ALTER TABLE `news_baijia` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `news_baijia` ENABLE KEYS */;


-- 导出  表 baidunews.news_entertainment 结构
CREATE TABLE IF NOT EXISTS `news_entertainment` (
  ...
  `time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='娱乐新闻列表';

-- 正在导出表  baidunews.news_entertainment 的数据：~1 rows (大约)
DELETE FROM `news_entertainment`;
/*!40000 ALTER TABLE `news_entertainment` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `news_entertainment` ENABLE KEYS */;


-- 导出  表 baidunews.news_internet 结构
CREATE TABLE IF NOT EXISTS `news_internet` (
  ...
  `time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='互联网新闻列表';

-- 正在导出表  baidunews.news_internet 的数据：~1 rows (大约)
DELETE FROM `news_internet`;
/*!40000 ALTER TABLE `news_internet` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `news_internet` ENABLE KEYS */;


-- 导出  表 baidunews.news_local 结构
CREATE TABLE IF NOT EXISTS `news_local` (
  ...
  `time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='本地新闻列表';

-- 正在导出表  baidunews.news_local 的数据：~1 rows (大约)
DELETE FROM `news_local`;
/*!40000 ALTER TABLE `news_local` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `news_local` ENABLE KEYS */;


-- 导出  表 baidunews.news_military 结构
CREATE TABLE IF NOT EXISTS `news_military` (
  ...
  `time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='军事新闻列表';

-- 正在导出表  baidunews.news_military 的数据：~1 rows (大约)
DELETE FROM `news_military`;
/*!40000 ALTER TABLE `news_military` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `news_military` ENABLE KEYS */;


-- 导出  表 baidunews.news_picture 结构
CREATE TABLE IF NOT EXISTS `news_picture` (
  ...
  `time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='图片新闻列表';

-- 正在导出表  baidunews.news_picture 的数据：~1 rows (大约)
...
-- 导出  表 baidunews.news_recommend 结构
CREATE TABLE IF NOT EXISTS `news_recommend` (
  ...
  `time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=49 DEFAULT CHARSET=utf8 COMMENT='推荐新闻列表';

-- 正在导出表  baidunews.news_recommend 的数据：~16 rows (大约)
...
-- 导出  表 baidunews.news_science 结构
CREATE TABLE IF NOT EXISTS `news_science` (
  ...
  `time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='科技新闻列表';

-- 正在导出表  baidunews.news_science 的数据：~1 rows (大约)
DELETE FROM `news_science`;
/*!40000 ALTER TABLE `news_science` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `news_science` ENABLE KEYS */;


-- 导出  表 baidunews.news_society 结构
CREATE TABLE IF NOT EXISTS `news_society` (
  ...
  `time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='社会新闻列表';

-- 正在导出表  baidunews.news_society 的数据：~1 rows (大约)
DELETE FROM `news_society`;
/*!40000 ALTER TABLE `news_society` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `news_society` ENABLE KEYS */;


-- 导出  表 baidunews.news_woman 结构
CREATE TABLE IF NOT EXISTS `news_woman` (
  ...
  `time` datetime NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8 COMMENT='女人新闻列表';

-- 正在导出表  baidunews.news_woman 的数据：~1 rows (大约)
DELETE FROM `news_woman`;
/*!40000 ALTER TABLE `news_woman` DISABLE KEYS */;
...
/*!40000 ALTER TABLE `news_woman` ENABLE KEYS */;
