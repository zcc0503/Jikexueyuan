...
//news_recommend
app.use('/news_recommend', orm.express(dburl, {
...
//news_baijia
app.use('/news_baijia', orm.express(dburl, {
    define: function(db, models, next) {
...
//news_local
app.use('/news_local', orm.express(dburl, {
    define: function(db, models, next) {
...
//news_internet
app.use('/news_internet', orm.express(dburl, {
    define: function(db, models, next) {
...
//news_science
app.use('/news_science', orm.express(dburl, {
    define: function(db, models, next) {
...
//news_woman
app.use('/news_woman', orm.express(dburl, {
    define: function(db, models, next) {
...
//news_picture
app.use('/news_picture', orm.express(dburl, {
    define: function(db, models, next) {
...
//news_military
app.use('/news_military', orm.express(dburl, {
    define: function(db, models, next) {
...
//news_society
app.use('/news_society', orm.express(dburl, {
    define: function(db, models, next) {
...
//news_entertainment
app.use('/news_entertainment', orm.express(dburl, {
    define: function(db, models, next) {
