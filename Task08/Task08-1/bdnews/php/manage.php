...
<table width="100%" height="642" border="1" cellpadding="8" cellspacing="1" >
    <tr>
        <td height="89" colspan="2"><strong>后台管理系统</strong></td>
    </tr>
    <tr>
        <td width="156" height="412" align="left" valign="top">
            <p><a href="manage.php">管理新闻</a></p> <p><a href="insert.php">发布新闻</a></p><p><a href="select.php">查看新闻</a></p></td>
        <td width="837" valign="top" bgcolor="#FFFFFF"><table width="743" border="0" cellpadding="8" cellspacing="1" >
                <tr>
    ...
    <tr>
        <td colspan="2"><strong>版权所有</strong></td>
    </tr>
</table>
</body>
</html>
